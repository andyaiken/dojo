...
export default class Dojo extends React.Component {
    ...
    addMonsterGroup(name) {
        var group = utils.createMonsterGroup();
        group.name = name;
    ...
    addMonster(name) {
        var monster = utils.createMonster();
        monster.name = name;
        var group = this.getMonsterGroup(this.state.selectedMonsterGroupID);
    ...
    addEncounter(name) {
        var encounter = utils.createEncounter();
        encounter.name = name;
    ...
    addEncounterSlot(monster, waveID) {
        ...
        var slot = utils.createEncounterSlot();
    ...
    addWaveToEncounter() {
        ...
        var wave = utils.createEncounterWave();
    ...
    addMapFolio(name) {
        var folio = utils.createMapFolio();
        folio.name = name;
