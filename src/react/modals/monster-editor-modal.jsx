...
export default class MonsterEditorModal extends React.Component {
    ...
    geneSplice(monsters) {
        ...
        utils.TRAIT_TYPES.forEach(type => {
    ...
    render() {
        try {
            ...
            switch (this.state.page) {
                case 'overview':
                    var catOptions = utils.CATEGORY_TYPES.map(cat => { return { id: cat, text: cat }; });
                    var sizeOptions = utils.SIZE_TYPES.map(size => { return { id: size, text: size }; });
