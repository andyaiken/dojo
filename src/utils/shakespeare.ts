...
export class Shakespeare {
	...
	private static bookPreposition() {
		const prepositions = [
			'and', 'in', 'of', 'with', 'against', 'for', 'to', 'towards'
		];
	...
	private static bookAbout() {
		const starts = [
			'treatise', 'essay', 'monograph', 'discourse', 'dissertation', 'primer', 'history', 'enchiridion'
		];
		...
		const about = [
			'about', 'on', 'concerning', 'regarding', 'on the subject of'
		];
