...
import { MonsterGroup, Monster, SIZE_TYPES, CATEGORY_TYPES } from '../../../models/monster-group';
...
export default class DemographicsModule extends React.Component<Props, State> {
