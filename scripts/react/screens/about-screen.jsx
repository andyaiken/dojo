            ...
            return (
                <div className="about">
                    ...
                    <div className="right-pane scrollable">
                        <div className="group">
                            <div className="heading">open game license version 1.0a</div>
                            <div className="text">The following text is the property of Wizards of the Coast, Inc. and is Copyright 2000 Wizards of the Coast, Inc ("Wizards"). All Rights Reserved.</div>
                            <ol>
